  ...
  execute (Discord, message, args, client) {
    if (args[0]) {
      ...
      const helpEmbed = new Discord.MessageEmbed()
        .setColor(message.guild.me.displayHexColor)
        .setTitle('**Commands**')
        .setDescription('Hi there! This is a project from `Aircraft Overviewer#4977` to bring fun to you all in an entertaining and administrative bot. My prefix is `ap`, feel free to search any commands you do not know with `ap help [command]`. My commands are as follows:');
